...
public class RecyclerDisplayAdapter
    extends RecyclerView.Adapter<RecyclerDisplayAdapter.ViewHolder> {

  Context context;
  ArrayList<DisplayItineraryModel> arrayList;
  String fragmentName;
  String[] afterWords =
      { "Weekend", "Extravaganza", "Winter", "Family", "Summer", "Bonus", "Festival" };
